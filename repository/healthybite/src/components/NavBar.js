        ...
        <div className=" top-0 sticky sm:absolute bg-healthyGreen shadow-xl py-3 w-full flex flex-col items-center justify-center">
            <div className="flex flex-row max-w-[800px] w-11/12 lg:w-full justify-between items-center ">
                ...
                <>
                    ...
                    <Link to="/" className="text-white font-quicksand text-sm hover:mt-1 hover:underline-offset-2 hover:border-b-1 hover:border-b-white  " ><FontAwesomeIcon className="text-white text-md pr-2" icon={faUser} />User Profile </Link>
                    <button onClick={()=>auth.signOut()} className="font-quicksand font-semibold text-sm text-healthyGreen hover:mt-1  px-3 py-1 rounded-3xl bg-white hover:bg-hbGreen  underline-offset-2">Log out</button>
                </>
                :
                <div>
