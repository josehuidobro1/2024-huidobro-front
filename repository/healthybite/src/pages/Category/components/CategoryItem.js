    ...
    <div className='flex flex-col w-full my-2'>
        <div className='w-full bg-healthyDarkOrange shadow-md p-2 rounded-md flex flex-row justify-between items-center font-quicksand'>
            <div className='flex flex-row items-center justify-start'>
                <FontAwesomeIcon icon={icon.icon} className='text-white text-3xl '/> 
                <p className='text-white font-semibold ml-2 text-md'>{category.name}</p>
            </div>
            <div className='flex flex-row justify-end items-center'>
                <div onClick={handleDelete} className='bg-white hover:bg-healthyGray hover:cursor-pointer rounded-full py-1 px-2 '>
