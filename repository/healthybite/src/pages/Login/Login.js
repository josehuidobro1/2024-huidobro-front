...
function Login() {
    ...
    return (
        <div className=" bg-healthyGray h-screen flex justify-center items-center bg-healthyGray ">
            ...
            <div className={`bg-healthyGray w-full sm:w-2/5 lg:w-2/5 xl:w-5/12 absolute flex  sm:left-20 lg:left-40 top-64 flex-col  ${signUp ? 'lg: top-12':'  sm:top-40'} `} >
                <div className={`flex  h-full  sm:mt-0 w-3/5 px-12 xs:px-16 sm:px-0  sm:w-4/5 lg:w-1/2  xl:w-full  w-full flex-col `}>
                    <h1 className= {`font-belleza text-4xl md:text-5xl lg:text-7xl text-darkGray ${forgot ? 'text-center':'text-left'}`}>Healthy Bite</h1>
                    {signUp ? (
                        <div classname='h-full  w-full'>
                            <div className="sm:mt-6 flex flex-col bg-healthyGray w-full">
                    ...
                    : ( forgot ?
                        (
                        <div className="flex flex-col w-full px-8 xs:px-0 sm:w-1/3 my-8">
