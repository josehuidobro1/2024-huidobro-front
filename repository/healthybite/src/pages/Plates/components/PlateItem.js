...
import { faBookmark, faCirclePlus, faEllipsisVertical, faPlus, faSquareMinus, faUtensils} from '@fortawesome/free-solid-svg-icons'
        ...
        <div className='z-5 flex w-full justify-between mt-2 bg-white p-1  items-center rounded-full shadow-md'>
            <div className='flex items-center'>
                ...
                <div className='flex flex-col justify-center items-start'>
                    ...
                    <p className='text-xs text-healthyDarkOrange  ml-3'>{foodPlate.reduce((acc, item)=>acc+=(item.calories_portion*item.amount),0)} calories</p>
                </div>
            </div>
            <div className='flex items-center'>
                {options &&
